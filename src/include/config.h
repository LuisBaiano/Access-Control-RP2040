...
#define MAX_USERS 16 // Capacidade máxima do espaço (ex: 5 para facilitar teste)
...
#define DEBOUNCE_TIME_US   200000 // 200ms para botões
...
#define PRIORITY_MATRIX      (tskIDLE_PRIORITY + 1)
